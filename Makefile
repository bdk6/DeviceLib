...
INCLUDES       = ../avrlib
devicelib.a:	button.o keypad.o lcd_44780.o
	avr-ar r devicelib.a button.o keypad.o lcd_44780.o


datefile.txt:
	date -u +%Y%m%d%H%M%S >datefile.txt

devicelib.elf:  devicelib_test.o button.o keypad.o lcd_44780.o
	$(CC) $(CFLAGS) $(LDFLAGS) -o devicelib.elf devicelib_test.o button.o keypad.o lcd_44780.o $(LDFLAGS) $(LIBS)

devicelib_test.o:  devicelib_test.c
	$(CC) $(CFLAGS) -c -I ${INCLUDES} devicelib_test.c

button.o:  button.c button.h device_config.h
	$(CC) $(CFLAGS) -c -I ${INCLUDES} button.c

keypad.o:  keypad.c keypad.h device_config.h
	$(CC) $(CFLAGS) -c -I ${INCLUDES} keypad.c

lcd_44780.o:	lcd_44780.c lcd_44780.h device_config.h
	$(CC) $(CFLAGS) -c -I ${INCLUDES} lcd_44780.c

devicelib.hex: devicelib.elf
	avr-objcopy -j .text -j .data -O ihex devicelib.elf devicelib.hex

devicelib_test.hex: devicelib_test.elf
	avr_objcopy -j .text -j .data -O ihex devicelib_test.efl devicelib_test.hex

devicelib_test.elf: devicelib_test.o button.o keypad.o lcd44780.o
	$(CC) $(CFLAGS) $(LDFLAGS) -o devicelib_test.elf devicelib_test.o buttons.o keypad.o lcd44780.o $(LDFLAGS) $(LIBS)
